...
public class ExceptionInterceptor extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(EmpolyeeAlreadyExists.class)
	public final ResponseEntity<ErrorDetails> employeealreadyexisit(EmpolyeeAlreadyExists ex, WebRequest request) throws Exception {
	...
	public final ResponseEntity<ErrorDetails> employeeidnotfount(EmployeeIdNotFound ex, WebRequest request) throws Exception {
		ErrorDetails errordetails=new ErrorDetails(LocalDateTime.now(),ex.getMsg(), request.getDescription(false));
				return new ResponseEntity<ErrorDetails>(errordetails, HttpStatus.BAD_REQUEST);
